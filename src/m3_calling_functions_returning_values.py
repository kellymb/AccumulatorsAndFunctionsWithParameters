...
def run_test_digits_in_power():
    ...
    b = 3
    d = 4
    print('Test 1 expected:', '9')
    print('       actual:', digits_in_power(b, d))
    b = 8
    d = 3
...
def run_test_fancy_sums_of_digits():
    ...
    print('       actual:', fancy_sums_of_digits(r))
    r = 2
    print('Test 2 expected:', '19084')
    print('       actual:', fancy_sums_of_digits(r))
    r = 35
    print('Test 3 expected:', '124309')
    print('       actual:', fancy_sums_of_digits(r))
...
def fancy_sums_of_digits(n):
    ...
    """
    # ------------------------------------------------------------------
    # DOME: 8. Implement and test this function.
    #
    ####################################################################
    # IMPORTANT: CALL, as many times as needed,
    #    the    sum_of_digits    function that is DEFINED ABOVE.
